    ...
    return (
        <div>
            <div className="jumbotron">
                ...
                <p className="lead">Aquí podrás encontrar productos de belleza y cuidado personal adecuados para todo tipo de piel y preferencia, además de grandes decuentos.</p>
                <hr className="my-4" />
